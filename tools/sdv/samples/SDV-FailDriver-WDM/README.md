<!---
    ...
    samplefwlink: https://go.microsoft.com/fwlink/p/?LinkId=617999
--->
...
2.  Click the **Rules** tab to select which driver DDI usage rules to verify when you start the analysis.
    ...
    -   [CancelSpinLock](https://msdn.microsoft.com/en-us/library/windows/hardware/ff542478)
    -   [IrqlIoApcLte](https://msdn.microsoft.com/en-us/library/windows/hardware/ff547759)
    -   [IrqlKeSetEvent](https://msdn.microsoft.com/en-us/library/windows/hardware/ff547835)
    -   [LowerDriverReturn](https://msdn.microsoft.com/en-us/library/windows/hardware/ff548273)
    -   [SpinLock (WDM)](https://msdn.microsoft.com/en-us/library/windows/hardware/ff551861)
