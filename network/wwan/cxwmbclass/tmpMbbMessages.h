...
#define MBB_UUID_INVALID_CONSTANT \
    { \
...
#define MBB_UUID_BASIC_CONNECT_CONSTANT \
    { \
        0xa289cc33, 0xbcbb, 0x8b4f, \
        { \
...
#define MBB_UUID_SMS_CONSTANT \
    { \
        0x533fbeeb, 0x14fe, 0x4467, \
        { \
...
#define MBB_UUID_USSD_CONSTANT \
    { \
        0xe550a0c8, 0x5e82, 0x479e, \
        { \
...
#define MBB_UUID_PHONEBOOK_CONSTANT \
    { \
        0x4bf38476, 0x1e6a, 0x41db, \
        { \
...
#define MBB_UUID_SAT_CONSTANT \
    { \
        0xd8f20131, 0xfcb5, 0x4e17, \
        { \
...
#define MBB_UUID_MS_VENDOR_EXTENSION_CONSTANT \
    { \
        0xb492e7e2, 0xadba, 0x499d, \
        { \
            0x84, 0x01, 0x77, 0x94, 0xbb, 0x91, 0x3c, 0x1c \
        } \
    }
// Authentication
...
#define MBB_UUID_AUTH_CONSTANT \
    { \
        0x1d2b5ff7, 0x0aa1, 0x48b2, \
        { \
...
#define MBB_UUID_DSS_CONSTANT \
    { \
        0xc08a26dd, 0x7718, 0x4382, \
        { \
...
#define MBB_UUID_MULTICARRIER_CONSTANT \
    { \
        0x8b569648, 0x628d, 0x4653, \
        { \
            0x9b, 0x9f, 0x10, 0x25, 0x40, 0x44, 0x24, 0xe1 \
        } \
    }
...
#define MBB_UUID_HOSTSHUTDOWN_CONSTANT \
    { \
        0x883b7c26, 0x985f, 0x43fa, \
        { \
...
#define MBB_UUID_VOICEEXTENSIONS_CONSTANT \
    { \
        0x8d8b9eba, 0x37be, 0x449b, \
        { \
            0x8f, 0x1e, 0x61, 0xcb, 0x03, 0x4a, 0x70, 0x2e \
        } \
    }
...
#define MBB_UUID_UICC_LOW_LEVEL_CONSTANT \
    { \
        0xc2f6588e, 0xf037, 0x4bc9, \
        { \
...
#define MBB_UUID_SARCONTROL_CONSTANT \
    { \
        0x68223d04, 0x9f6c, 0x4e0f, \
        { \
...
#define MBB_UUID_BASIC_CONNECT_EXT_CONSTANT \
    { \
        0x3d01dcc5, 0xfef5, 0x4d05, \
        { \
...
#define MBB_UUID_MODEM_LOG_TRANSFER_CONSTANT \
    { \
        0x0ebb1ceb, 0xaf2d, 0x484d, \
        { \
            0x8d, 0xf3, 0x53, 0xbc, 0x51, 0xfd, 0x16, 0x2c \
        } \
    }
//
// Context Type GUIDs
...
// 64F65862-6954-4FB3-B6E1-807461ABEBA0
DEFINE_GUID(MBB_UUID_CONTEXT_TYPE_SUPL, 0x64F65862, 0x6954, 0x4FB3, 0xB6, 0xE1, 0x80, 0x74, 0x61, 0xAB, 0xEB, 0xA0);
...
#define MBB_STATUS_SUCCESS(STATUS) (((STATUS) == MBB_STATUS_SUCCESS) || ((STATUS) == MBB_STATUS_SMS_MORE_DATA))
...
#define MBB_STATUS_IS_4_0(MBBSTATUS) (((MBBSTATUS) >= MBB_STATUS_4_0_START) && ((MBBSTATUS) < MBB_STATUS_4_0_END))
#define MBB_STATUS_4_0_INDEX(MBBSTATUS) ((MBBSTATUS)-MBB_STATUS_4_0_START)
#define MBB_STATUS_4_0_COUNT() (MBB_STATUS_4_0_END - MBB_STATUS_4_0_START)
...
#define MBB_IS_DEVICE_REGISTERED(_State_) \
    (((_State_) == MbbRegisterStateHome) || ((_State_) == MbbRegisterStateRoaming) || ((_State_) == MbbRegisterStatePartner))
#include <packon.h>
...
#define MBIM_MS_EXTENDED_VER_4_0 (0x400)
...
#define MBB_TLV_TYPE_OSID (18)

#define MBB_TLV_TYPE_3GPP_REL_VERSION (19)

#define MBB_TLV_TYPE_URSP_RULES_TD_ONLY (20)

#define MBB_TLV_TYPE_SESSION_ID (21)
...
typedef enum _USB_CAP_DEVICE_TYPE
{
...
typedef enum _MBB_STATUS
{
    ...
    MBB_STATUS_4_0_START = 200,
    MBB_STATUS_MATCHING_PDU_SESSION_FOUND = MBB_STATUS_4_0_START,
    MBB_STATUS_DESSOCIATION_NEEDED_FOR_APPLICATION = 201,
    MBB_STATUS_ERROR_INVALID_SLOT = 202,
    MBB_STATUS_NO_MATCHING_URSP_RULE = 203,
    MBB_STATUS_NO_DEFAULT_URSP_RULE = 204,
    MBB_STATUS_4_0_END = (MBB_STATUS_NO_DEFAULT_URSP_RULE + 1),
...
typedef enum _MBB_MESSAGE_TYPE
{
...
typedef enum _MBB_COMMAND_TYPE
{
...
typedef enum _MBB_HOSTSHUTDOWN_CID
{
...
typedef enum _MBB_VOICEEXTENSIONS_CID
{
...
typedef enum _MBB_BASICCONNECTEXT_CID
{
...
typedef enum _MBB_CELLULAR_CLASS
{
...
typedef enum _MBB_DATA_CLASS_VALUE
{
    MbbDataClassNone = 0,
...
typedef enum _MBB_DATA_SUBCLASS_VALUE
{
...
typedef enum _MBB_FREQUENCY_RANGE
{
...
typedef enum _MBB_BAND_CLASS_VALUE
{
...
typedef enum _MBB_SMS_CAPS_VALUE
{
    MbbSmsCapsNone = 0,
...
typedef enum _MBB_CONTROL_CAPS_VALUE
{
...
typedef enum _MBB_PIN_OPERATION
{
...
typedef enum _MBB_PROVIDER_STATE_VALUE
{
...
typedef enum _MBB_REGISTER_ACTION
{
...
typedef enum _MBB_REGISTER_STATE
{
...
typedef enum _MBB_REGISTER_MODE
{
...
typedef enum _MBB_PACKET_SERVICE_ACTION
{
...
typedef enum _MBB_PACKET_SERVICE_STATE
{
...
typedef enum _MBB_CONTEXT_IP_TYPE
{
...
typedef enum _MBB_ACTIVATION_COMMAND
{
...
typedef enum _MBB_AUTH_PROTOCOL
{
...
typedef enum _MBB_ACTIVATION_STATE
{
...
typedef enum _MBB_VOICE_CALL_STATE
{
...
typedef enum _MBB_SMS_CDMA_LANGUAGE
{
...
typedef enum _MBB_SMS_CDMA_ENCODING
{
...
typedef enum _MBB_SMS_MESSAGE_STATUS
{
...
typedef enum _MBB_REG_FLAGS_VALUE
{
    MbbRegFlagsNone = 0,
...
typedef enum _MBB_SMS_STATUS_FLAGS_VALUE
{
    MbbSmsFlagNone = 0,
...
typedef enum _MBB_DSS_PAYLOAD_SUPPORT
{
    MbbDssPayloadNone = 0,
...
typedef enum _MBB_DSS_LINK_STATE
{
    MbbDssLinkDeactivate = 0,
    MbbDssLinkActivate = 0x1
} MBB_DSS_LINK_STATE;

typedef enum _MBB_IP_CONFIGURATION_FLAGS_VALUE
{
    MbbIpFlagsNone = 0,
...
typedef enum _MBB_NETWORK_IDLE_HINT_STATE
{
...
typedef enum _MBB_SAR_CONTROL_MODE
{
...
typedef enum _MBB_SAR_WIFI_HARDWARE_INTEGRATION
{
...
typedef enum _MBB_SAR_TRANSMISSION_STATUS_NOTIFICATION_STATE
{
...
typedef enum _MBB_SAR_TRANSMISSION_STATUS
{
...
typedef enum _MBB_BASICCONNECTEXT_CONTEXT_ROAMING_CONTROL
{
...
typedef enum _MBB_BASICCONNECTEXT_CONTEXT_ENABLE
{
...
typedef enum _MBB_BASICCONNECTEXT_CONTEXT_SOURCE
{
...
typedef enum _MBB_BASICCONNECTEXT_CONTEXT_OPERATIONS
{
...
typedef enum _MBB_BASICCONNECTEXT_NETWORK_BLACKLIST_STATE
{
...
typedef enum _MBB_BASICCONNECTEXT_NETWORK_BLACKLIST_TYPE
{
...
typedef enum _MBB_BASICCONNECTEXT_LTEATTACH_ROAMING_CONTROL
{
...
typedef enum _MBB_BASICCONNECTEXT_LTEATTACH_CONTEXT_OPERATIONS
{
...
typedef enum _MBB_BASICCONNECTEXT_LTEATTACH_STATE
{
...
typedef enum _MBB_BASICCONNECTEXT_UICCSLOT_STATE
{
...
typedef enum _MBB_BASICCONNECTEXT_MODEM_LOGGING_LEVEL_CONFIG
{
...
typedef enum _MBB_SUBSCRIBER_READY_STATUS_FLAGS
{
...
typedef enum _MBB_ACCESS_MEDIA_PREF
{
...
typedef enum _MBB_VISIBLE_PROVIDERS_ACTION_VALUE
{
...
typedef enum _MBB_SMS_STORAGE_STATE
{
...
typedef enum _MBB_USSD_RESPONSE
{
...
typedef enum _MBB_USSD_SESSION_STATE
{
    MbbUSSDNewSession = 0,
...
typedef enum _MBB_UICC_APP_TYPE
{
...
typedef enum _MBB_UICC_FILE_ACCESSIBILITY
{
...
typedef enum _MBB_UICC_FILE_TYPE
{
...
typedef enum _MBB_UICC_FILE_STRUCTURE
{
...
typedef enum _MBB_UICCSLOT_STATE
{
...
typedef enum _MBB_REGISTRATION_VOICE_SUPPORT
{
...
typedef enum _MBB_REGISTRATION_CDMA_ROAM_MODE
{
...
typedef enum _MBB_IMS_VOICE_STATUS
{
...
typedef enum _MBB_LOCATION_TRIGGER_MODE
{
...
typedef enum _MBB_UICC_PASSTHROUGH_ACTION
{
    MbbUiccPassThroughDisable = 0,
    MbbUiccPassThroughEnable = 1
} MBB_UICC_PASSTHROUGH_ACTION;

typedef enum _MBB_UICC_PASSTHROUGH_STATUS
{
...
typedef struct _MBB_SET_MS_CONTEXT_PROVISIONED_CONTEXT_V2_EX4
{
    MBB_BASICCONNECTEXT_CONTEXT_OPERATIONS Operation;
    GUID ContextType;
    MBB_CONTEXT_IP_TYPE IPType;
    ...
    MBB_TLV_IE Snssai;
    UCHAR DataBuffer[1];
} MBB_SET_MS_CONTEXT_PROVISIONED_CONTEXT_V2_EX4;

typedef struct _MBB_SET_MS_CONTEXT_PROVISIONED_CONTEXT_V2_EX4* PMBB_SET_MS_CONTEXT_PROVISIONED_CONTEXT_V2_EX4;

typedef struct _MBB_MS_CONTEXT_V2_EX4
{
    ULONG ContextId;
    GUID ContextType;
    MBB_CONTEXT_IP_TYPE IPType;
    ...
    MBB_TLV_IE Snssai;
    UCHAR DataBuffer[1];
} MBB_MS_CONTEXT_V2_EX4;

typedef struct _MBB_MS_CONTEXT_V2_EX4* PMBB_MS_CONTEXT_V2_EX4;
...
typedef enum _MBB_MODEM_CONFIG_STATUS
{
...
typedef enum _MBB_DEFAULT_PDU_HINT
{
...
extern RPC_IF_HANDLE __MIDL_itf_MbbMessages_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_MbbMessages_0000_0000_v0_0_s_ifspec;
