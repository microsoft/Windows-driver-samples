 ...
 * 
 *****************************************************************************/
#ifndef __INC_HALCOMREG_H
#define __INC_HALCOMREG_H
...
#define REG_WOL_EVENT					0x0081 //RTL8192C, RTL8723A
#define REG_MCUTSTCFG					0x0084
#define REG_HMEBOX_EXT_0				0x0088
#define REG_FW_DBG_STATUS				0x0088 // Support on 8723B/8192E/8812A/8821A
...
#define REG_LLT_ADDR					0x01E4//20130415 KaiYuan add for 8814
#define REG_HMEBOX_EXT0					0x01F0	// For 8723B, 8192E, 8812, 8821
#define REG_HMEBOX_EXT1					0x01F4	// For 8723B, 8192E, 8812, 8821
#define REG_HMEBOX_EXT2					0x01F8	// For 8723B, 8192E, 8812, 8821
#define REG_HMEBOX_EXT3					0x01FC	// For 8723B, 8192E, 8812, 8821


#define REG_HMEBOX_EXT_0_88E			((pHalData->bIsMPChip) ? 0x01F0 : 0x0088)
#define REG_HMEBOX_EXT_1_88E			((pHalData->bIsMPChip) ? 0x01F4 : 0x008A)
#define REG_HMEBOX_EXT_2_88E			((pHalData->bIsMPChip) ? 0x01F8 : 0x008C)
#define REG_HMEBOX_EXT_3_88E			((pHalData->bIsMPChip) ? 0x01FC : 0x008E)
...
#define	REG_RXPKT_NUM_OLD				0x0287 // The number of packets in RXPKTBUF.	
...
#define REG_TXPKTBUF_BCNQ_BDNY1			0x0424
...
// [483h] REG_DATA_SC
// [3:0] = BIT_TXSC_20M, [7:4] = BIT_TXSC_40M
...
#define REG_HW_SEQ_NUM_0			0x04D8
#define REG_HW_SEQ_NUM_1			0x04DA
...
#define REG_FW_AOAC_DBG_MSG_1		0x0630
#define REG_FW_AOAC_DBG_MSG_2		0x0634
#define REG_USTIME_EDCA				0x0638
#define REG_MAC_SPEC_SIFS			0x063A
#define REG_RESP_SIFS_CCK			0x63C
#define REG_RESP_SIFS_OFDM			0x63E
#define REG_TRX_SIFS_OFDM			0x517
// 20100719 Joseph: Hardware register definition change. (HW datasheet v54)
// 2013115 Roger: Hardware register definition error. (HW datasheet ??)
#define REG_RESP_CCK_SIFS				0x063C // CCK R2T [15:8], T2T[7:0]
#define REG_RESP_OFDM_SIFS				0x063E // OFDM R2T [15:8], T2T[7:0]
...
// for 8814AE memory mapping CTRL_INFO 4KB /RPT_CRC 4KB/MACID 8KB
#define MEMORY_MAP_BUF_READ            0x8000
#define CTRL_INFO_PAGE                 0x660
#define RPT_CRC                        0x661
#define TX_SHORT_CUT_MACID_0_31        0x662
#define TX_SHORT_CUT_MACID_32_63       0x663 
#define RPT_BUF_DESC_NUM_8814A     256

#define RPT_BUF_DESC_NUM_8821B     256

#define RPT_BUF_DESC_NUM_8822B     256
...
#define	ISR_92C					REG_HISR

//
// <Roger_TODO> We should take RTL8723B into consideration, 2012.10.08
//
#define GET_ISR(_Adapter)	\
	(IS_HARDWARE_TYPE_JAGUAR(_Adapter)||IS_HARDWARE_TYPE_8723B(_Adapter)  || IS_HARDWARE_TYPE_8703B(_Adapter) || IS_HARDWARE_TYPE_8723D(_Adapter) || IS_HARDWARE_TYPE_8188F(_Adapter) || IS_HARDWARE_TYPE_8192E(_Adapter))?REG_HISR0:		\
	(IS_HARDWARE_TYPE_8188E(_Adapter) ? ISR_88E : ISR_92C)
...
#if USE_8814AS_MACRO_SETTING == 1
#define _LLT_INIT_DATA(x)			(((x) & 0xFFF)<<16)	//20130415 KaiYuan modify for 8814
#define _LLT_INIT_ADDR(x)			((x) & 0xFFF )		//20130415 KaiYuan Modify for 8814
#else
...
#define _LLT_INIT_DATA_8821B(x)			(((x) & 0xFFF)<<16)
#define _LLT_INIT_ADDR_8821B(x)			((x) & 0xFFF) 

#define _LLT_INIT_DATA_8822B(x)			(((x) & 0xFFF)<<16)
#define _LLT_INIT_ADDR_8822B(x)			((x) & 0xFFF) 
...
#define	HAL_DATA_SC_DONT_CARE	0
#define	HAL_DATA_SC_UPPER		1
#define	HAL_DATA_SC_LOWER		2
#define	HAL_DATA_DUPLICATE		3
...
#define ACRC32					BIT(8)
#define AICV					BIT(9)
//ADF is not used in 8822B, Bit 11 has other purpose and should not be set when init
#define ADF					BIT(11)
#define ACF					BIT(12)
#define AMF					BIT(13)
...
#define WLAN_TX_EXTQ_DEVICE_ID 			7	// 0b[16], 110b[15:13]
...
#define EXTRA_QUEUE_IDX    			4 //20130422 KaiYuan added for 8814 Extra Queue
...
#define	SDIO_REG_H2C					0x0060 // Host to Client
...
#define	HAL_MSDU_LIFE_TIME_UNIT_128		128	// in us, said by Tim.
#define HAL_MSDU_LIFE_TIME_UNIT_256		256 // in us, said by Tim.
...
// General definitions
//========================================================
//YP change for 88E SMIC
#define LAST_ENTRY_OF_TX_PKT_BUFFER_8188E(__Adapter)	   ( IS_VENDOR_8188E_SMIC_SERIES(__Adapter) ? 255 : 175 )
#define LAST_ENTRY_OF_TX_PKT_BUFFER_8812       255
#define LAST_ENTRY_OF_TX_PKT_BUFFER_8821B      255
#define LAST_ENTRY_OF_TX_PKT_BUFFER_8723D      255
#define LAST_ENTRY_OF_TX_PKT_BUFFER_8822B      2048-1
...
#define POLLING_READY_TIMEOUT_COUNT_88E(__Adapter)		((GET_HAL_DATA(__Adapter)->bIsMPChip) ? (u4Byte)3000 : (u4Byte)1000)

#define POLLING_READY_TIMEOUT_COUNT_92C			1000
...
#endif // #ifndef __INC_HALCOMREG_H
