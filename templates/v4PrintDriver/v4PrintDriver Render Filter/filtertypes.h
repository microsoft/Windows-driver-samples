...
// Internal Types
//
typedef std::auto_ptr<v4PrintDriver_Render_Filter::PrintTicketHandler>         PrintTicketHandler_t;
typedef std::auto_ptr<SafeHGlobal>                              SafeHGlobal_t;
typedef std::auto_ptr<SafeHPTProvider>                          SafeHPTProvider_t;
typedef CComPtr<v4PrintDriver_Render_Filter::FilterLiveness>                   FilterLiveness_t;
