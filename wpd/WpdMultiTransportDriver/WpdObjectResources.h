...
public:
    ...
    HRESULT OnGetResourceAttributes(_In_ IPortableDeviceValues*  pParams,
                                    _In_ IPortableDeviceValues*  pResults);

    HRESULT OnOpenResource(_In_ IPortableDeviceValues*  pParams,
                           _In_ IPortableDeviceValues*  pResults);

    HRESULT OnReadResource(_In_ IPortableDeviceValues*  pParams,
                           _In_ IPortableDeviceValues*  pResults);

    HRESULT OnCloseResource(_In_ IPortableDeviceValues*  pParams,
                            _In_ IPortableDeviceValues*  pResults);
private:
    HRESULT GetSupportedResourcesForObject(_In_ LPCWSTR                       wszObjectID,
                                           _In_ IPortableDeviceKeyCollection* pKeys);

    HRESULT GetResourceAttributesForObject(_In_ LPCWSTR                wszObjectID,
                                           _In_ REFPROPERTYKEY         Key,
                                           _In_ IPortableDeviceValues* pAttributes);

    HRESULT ReadDataFromResource(_In_   WpdObjectResourceContext* pResourceContext,
