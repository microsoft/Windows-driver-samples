//
// This class represents a the Bluetooth Hands-Free Profile A2DP Headphone device.
...
typedef union
{
    struct
    {
        ULONG                   A2dpHwSpecificParam01;
        ULONG                   A2dpHwSpecificParam02;
        ULONG                   A2dpHwSpecificParam03;
    };
    LONGLONG Alignment;
    ...
    public CUnknown    
{
    private:
        ...
        A2DPHPDEVICE_CODEC_CAPABILITIES         m_ConnectedCodecCaps;
    ...
    private:
        ...
        NTSTATUS    SetA2dpHpStreamOpen(ULONG EpIndex, PKSDATAFORMAT_WAVEFORMATEXTENSIBLE pStreamFormat, PSIDEBANDAUDIO_ENDPOINT_DESCRIPTOR pEndpointDescriptor);
