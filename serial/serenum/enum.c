...
#define PERFCNT 1
   ...
   *PDSRMissing = FALSE;
   ...
   pReadBuf = ExAllocatePool2(POOL_FLAG_NON_PAGED, MAX_DEVNODE_NAME + sizeof(CHAR), SERENUM_POOL_TAG);
...
#pragma warning(suppress: 26018)
    ...
    length = sizeof(KEY_VALUE_FULL_INFORMATION) + KeyNameStringLength
      + DataLength;
    fullInfo = ExAllocatePool2(POOL_FLAG_PAGED, length, SERENUM_POOL_TAG);
